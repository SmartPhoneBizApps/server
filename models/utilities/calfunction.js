                          ...
                          for (var j = 0; j < fieldArray.length; j++) {
                              ...
                              if (getFieldType) {
                                  ...
                                  if (getFieldType.toLowerCase() == "date") {
                                      ...
                                      if (typeField == "Header") {
                                          fieldObj.push(data.hasOwnProperty(Source)? parseFloat(data[Source]): 0);
                                      } else {
                                          fieldObj.push(data[fieldName][itemCnt].hasOwnProperty(Source)? parseFloat(data[fieldName][itemCnt][Source]): 0);
                                      }
                                  }
                              } else {
                                  // Field Type is  null
          ...
          config["Header"].forEach((configItem) => {
              if (this.hasNull(configItem["CalculatedFormula"], 4)) {
                  ...
                  if (typeof this[fun] !== "undefined") {
                      ...
                      outdata[configItem["CalculatedFormula"]["Target"]] = this[fun](fieldObj); // call function and assign value in header array
                  } else {
                      outdata[configItem["CalculatedFormula"]["Target"]] = "";
                  }
              }
            ...
            var getFieldType="";
                 ...
                 console.log("getFieldType --->"+getFieldType);
                                  if (getFieldType.toLowerCase() == "date") {
                                      ...
                                      if (outdata[field["Source"]] !== undefined && outdata[field["Source"]] !== null && outdata[field["Source"]] !== "") {
                                          fieldObj.push(outdata.hasOwnProperty(field["Source"]) ? parseFloat(outdata[field["Source"]]) : 0);
                                      } else {
                                          fieldObj.push(0);
                                      }
                                  }
              ...
              console.log("COMPARE");
                              if (getFieldType.toLowerCase() == "date") {
                                  fieldObj.push(new Date(configItem["CalculatedFormula"]["value"]));
                              } else if (getFieldType.toLowerCase() == "string") {
                                  fieldObj.push(configItem["CalculatedFormula"]["value"]);
                              } else {
                                  fieldObj.push(parseFloat(configItem["CalculatedFormula"]["value"]));
                              }
              console.log(fieldObj);
                          }
                      } else {
