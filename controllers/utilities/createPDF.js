...
const pdfMake = require("./pdfmake"); // this points to pdfmake.js in CreatePDF folder
const vfsFonts = require("./vfs_fonts"); // this points to vfs_fonts.js in CreatePDF folder
