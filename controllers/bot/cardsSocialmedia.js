...
exports.cardsSocialmedia = asyncHandler(async (req, res, next) => {
  ...
  console.log("SMedia", SMediaAccountID);
  outdata = {};
  cardOut = [];
  ...
  if (!smedia) {
    ...
    if (user) {
      ...
      if (!smedia.accessToken) {
        ...
        console.log("Application", req.headers.applicationid);
        console.log("CardType", req.headers.cardtype);
